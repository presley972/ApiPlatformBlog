...
class AppFixtures extends Fixture
{
    ...
    private const USERS = [
        [
            ...
            'name' => 'Piotr Jura',
            'password' => 'secret123#',
            'roles' => [Utilisateur::ROLE_SUPERADMIN],
            'enabled' => true
        ],
        [
            'username' => 'john_doe',
        ...
        [
            ...
            'name' => 'Jedi Knight',
            'password' => 'secret123#',
            'roles' => [Utilisateur::ROLE_COMMENTATOR],
            'enabled' => true
        ],
    ];
    /**
    ...
    protected function getRandomUserReference($entity): Utilisateur
    {
        ...
        if ($entity instanceof BlogPost && !count(
                array_intersect(
                    $randomUser['roles'],
                    [Utilisateur::ROLE_SUPERADMIN, Utilisateur::ROLE_ADMIN, Utilisateur::ROLE_WRITER]
                )
            )) {
        ...
        if ($entity instanceof Comment && !count(
                array_intersect(
                    $randomUser['roles'],
                    [
                        Utilisateur::ROLE_SUPERADMIN,
                        Utilisateur::ROLE_ADMIN,
                        Utilisateur::ROLE_WRITER,
                        Utilisateur::ROLE_COMMENTATOR,
                    ]
                )
            )) {
            return $this->getRandomUserReference($entity);
